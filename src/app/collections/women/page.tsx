// src/app/collections/women/page.tsx
"use client";
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        ...
        <div className="mb-16">
          ...
          <h1 className="text-5xl md:text-8xl font-black uppercase tracking-tighter mb-4">
            Women's <span className="text-zinc-500">Collection</span>
          </h1>
          <p className="text-lg md:text-xl text-zinc-400 max-w-2xl">
            Discover styles that empower. From minimalist basics to statement pieces.
          </p>
        </div>
