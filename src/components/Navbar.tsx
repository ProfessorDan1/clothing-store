          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="group flex items-center gap-3">
              <div className="relative w-11 h-11 rounded-lg overflow-hidden bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 shadow-xl group-hover:scale-105 transition-transform">
                <Image src="/logo.png" alt="JFS World" fill sizes="44px" className="object-cover" />
              </div>
            ...
            <nav className="hidden md:flex items-center gap-1">
              <Link href="/" className="px-4 py-2 text-sm font-medium text-white hover:text-purple-300 transition-colors">
                Home
              </Link>
              <Link href="/shop" className="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white transition-colors">
                Shop
              </Link>
              <Link href="/collections" className="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white transition-colors">
                Collections
              </Link>
              <Link href="/about" className="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white transition-colors">
                About
              </Link>
              <Link href="/contact" className="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white transition-colors">
                Contact
              </Link>
            </nav>
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Cart */}
              <Link href="/cart" className="relative p-2.5 rounded-lg hover:bg-white/10 transition-colors group" aria-label="Cart">
              ...
              {/* Account */}
              <Link href="/account" className="hidden md:block p-2.5 rounded-lg hover:bg-white/10 transition-colors" aria-label="Account">
